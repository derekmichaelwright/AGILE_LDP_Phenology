...
xx <- ff %>% mutate(Size = 1)
# Plot (a) Map
invisible(png("Additional/Temp/Temp_F01_1.png", width = 1200, height = 450, res = 600)) #res = 150
...
```{r echo = F}
image_read("Additional/Additional_Figure_01.png")
```
...
invisible(png("Additional/Additional_Figure_01.png", 
              width = 3600, height = 2055, res = 600)) #res = 150
par(mai = c(0,0,0,0), xaxs = "i",yaxs = "i")
...
```{r echo = F}
image_read("Supplemental_Figure_01.png")
```
...
# Save
ggsave("Additional/Temp/Temp_F02_1.png", mp1, width = 12, height = 4, dpi = 600)
ggsave("Additional/Temp/Temp_F02_2.png", mp2, width = 12, height = 4, dpi = 600)
ggsave("Additional/Temp/Temp_F02_3.png", mp3, width = 12, height = 4, dpi = 600)
# Append (a), (b) and (c)
mp1 <- image_read("Additional/Temp/Temp_F02_1.png")  %>% 
  image_annotate("(a)", size = 150)
mp2 <- image_read("Additional/Temp/Temp_F02_2.png") %>% 
  image_annotate("(b)", size = 150)
mp3 <- image_read("Additional/Temp/Temp_F02_3.png") %>% 
  image_annotate("(c)", size = 150)
...
```{r echo = F}
image_read("Additional/Additional_Figure_02.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_03.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_04.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_02.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_03.png")
```
...
xx <- xx %>% filter(!Origin %in% c("ICARDA","USDA","Unknown")) %>% 
  ...
  ungroup() %>% as.data.frame()
xx[is.na(xx)] <- 0 
invisible(png("Additional/Temp/Temp_F03_3.png", width = 4800, height = 2200, res = 600)) #2400, 1100, res = 150
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
...
rgl::writeWebGL(filename = "Additional/Additional_Figure_05.html", 
...
```{r echo = F}
image_read("Additional/Additional_Figure_06.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_07.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_08.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_09.png")
```
...
invisible(png("Additional/Additional_Figure_09.png", 
              width = 7200, height = 4400, res = 600)) #res = 150
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
mapBubbles(dF = xx, nameX = "Lon", nameY = "Lat", nameZColour = "Cluster",
           ...
           oceanCol = "grey90", landCol = "white", borderCol = "black")
legend(-139.5, 15.5, title = "Cluster", legend = 1:8, col = colors,
       pch = 16, cex = 2, pt.cex = 3, box.lwd = 2)
invisible(dev.off())
```
...
for (i in 1:324) {
  png(paste0("Additional/Entry_3D/3D_Entry_", str_pad(i, 3, pad = "0"), ".png"), 
      width = 1000, height = 1000, res = 600) #res = 200
  gg_PTplane(xx, i)
  dev.off()
}
# Create PDF
...
```{r echo = F}
image_read("Supplemental_Figure_04.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_10.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_05.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_11.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_12.png")
```
...
```{r echo = F}
image_read("Additional/Additional_Figure_13.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_06.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_07.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_08.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_09.png")
```
...
mp <- ggarrange(mp1, mp2, ncol = 1, common.legend = T, legend = "bottom")
# Save
ggsave("Additional/Temp/Temp_SF09_1.png", mp1, width = 10, height = 13 * 3 / 8.2, dpi = 600)
ggsave("Additional/Temp/Temp_SF09_2.png", mp2, width = 10, height = 13 * 3 / 8.2, dpi = 600)
...
```{r echo = F}
image_read("Additional/Additional_Figure_14.png")
```
...
```{r, echo = F}
image_read("Supplemental_Figure_10.png")
```
...
```{r echo = F}
image_read("Supplemental_Figure_11.png")
```
