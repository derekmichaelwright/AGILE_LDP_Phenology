...
par(mai = c(0,0,0,0), xaxs = "i",yaxs = "i")
mapBubbles(dF = x1, nameX = "Lon", nameY = "Lat", nameZSize = "Count", 
           nameZColour = "darkred", xlim = c(-140,110), ylim = c(5,20),
           oceanCol = "grey90", landCol = "white", borderCol = "black")
invisible(dev.off())
```
...
mp <- ggplot(xx, aes(x = Value, y = Expt, fill = Trait)) + 
  ...
  theme_AGL + labs(y = NULL, x = "Days After Sowing") +
  theme(legend.position = "top", legend.margin = unit(c(0,0,0,0), "cm")) 
...
xx <- xx %>% filter(!Origin %in% c("ICARDA","USDA","Unknown")) %>% 
  ...
  ungroup() %>% as.data.frame()
xx[is.na(xx)] <- 0 
png("Additional/Temp/Temp_F03_3.png", width = 4800, height = 2200, res = 600)
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
...
[Click here to view as an interactive plot](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/Additional/Additional_Figure_06.html)
...
[Click here to view as an interactive plot](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/Additional/Additional_Figure_09.html)
