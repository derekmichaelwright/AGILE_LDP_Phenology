...
> - `r shiny::icon("save")` [data/data_ldp.csv](data/data_ldp.csv)
> - `r shiny::icon("save")` [data/data_countries.csv](data/data_countries.csv)
> - `r shiny::icon("save")` [data/data_raw.csv](data/data_raw.csv)
> - `r shiny::icon("save")` [data/data_env.csv](data/data_env.csv)
> - `r shiny::icon("save")` [data/data_info.csv](data/data_info.csv)
...
```{r echo = F}
DT::datatable(read.csv("Supplemental_Table_02.csv"))
```
...
> - `r shiny::icon("chart-line")` [Additional/Entry_Phenology/](https://github.com/derekmichaelwright/AGILE_LDP_Phenology/tree/master/Additional/Entry_Phenology/){target="_blank"}
> - `r shiny::icon("file-pdf")` [Additional/pdf_Phenology.pdf](https://github.com/derekmichaelwright/AGILE_LDP_Phenology/blob/master/Additional/pdf_Phenology.pdf)
...
ggsave("Additional/Additional_Figure_03.png", mp, width = 6, height = 4, dpi = 600)
```

---

## Additional Figure 4: MacroEnv Phenology
...
ggsave("Additional/Additional_Figure_04.png", mp, width = 8, height = 6, dpi = 600)
```
...
> - `r shiny::icon("save")` [data/data_pca_results.csv](data/data_pca_results.csv)

```{r echo = F, eval = T}
DT::datatable(read.csv("data/data_pca_results.csv"))
```
...
> - `r shiny::icon("chart-line")` [Additional/Additional_Figure_05.html](Additional/Additional_Figure_05.html){target="_blank"}
> - `r shiny::icon("chart-line")` [Additional/Animation_PCA.gif](Additional/Animation_PCA.gif){target="_blank"}

<iframe
  src="Additional/Additional_Figure_05.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>

![](Additional/Animation_PCA.gif)
...
> - `r shiny::icon("chart-line")` [Additional/Additional_Figure_06.html](Additional/Additional_Figure_06.html){target="_blank"}

<iframe
  src="Additional/Additional_Figure_06.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
> - `r shiny::icon("chart-line")` [Additional/Additional_Figure_09.html](Additional/Additional_Figure_09.html){target="_blank"}

<iframe
  src="Additional/Additional_Figure_09.html"
  style="width:100%; height:600px;"
></iframe>
...
> - `r shiny::icon("chart-line")` [Additional/Entry_TP/](https://github.com/derekmichaelwright/AGILE_LDP_Phenology/tree/master/Additional/Entry_TP/){target="_blank"}
> - `r shiny::icon("file-pdf")` [Additional/pdf_TP.pdf](Additional/pdf_TP.pdf)
...
> - `r shiny::icon("chart-line")` [Additional/Entry_3D/](https://github.com/derekmichaelwright/AGILE_LDP_Phenology/tree/master/Additional/Entry_3D/){target="_blank"}
> - `r shiny::icon("chart-line")` [Additional/Animation_3D.gif](Additional/Animation_3D.gif){target="_blank"}
> - `r shiny::icon("file-pdf")` [Additional/pdf_3D.pdf](Additional/pdf_3D.pdf)
...
> - `r shiny::icon("chart-line")` [Additional/Entry_Model/](https://github.com/derekmichaelwright/AGILE_LDP_Phenology/tree/master/Additional/Entry_Model/){target="_blank"}
> - `r shiny::icon("file-pdf")` [Additional/pdf_model.pdf](Additional/pdf_model.pdf)
> - `r shiny::icon("save")` [data/model_t+p_coefs.csv](data/model_t+p_coefs.csv)
> - `r shiny::icon("save")` [data/model_t+p.csv](data/model_t+p.csv)
> - `r shiny::icon("save")` [data/model_t+p_d.csv](data/model_t+p_d.csv)

```{r echo = F, eval = T}
DT::datatable(read.csv("data/model_t+p_coefs.csv"))
```
...
> - `r shiny::icon("save")` [data/model_txp.csv](data/model_txp.csv)
> - `r shiny::icon("save")` [data/model_txp_d.csv](data/model_txp_d.csv)
> - `r shiny::icon("save")` [data/model_txp_coefs.csv](data/model_txp_coefs.csv)

```{r echo = F, eval = T}
DT::datatable(read.csv("data/model_txp_coefs.csv"))
```
...
> - `r shiny::icon("save")` [Supplemental_Table_03.csv](Supplemental_Table_03.csv)
...
```{r echo = F}
DT::datatable(read.csv("Supplemental_Table_03.csv"))
```
...
ggsave("Supplemental_Figure_05.png", mp, width = 12, height = 5, dpi = 600, bg = "white")
```
...
> - `r shiny::icon("save")` [data/model_test.csv](data/model_test.csv)
> - `r shiny::icon("save")` [data/model_test_d.csv](data/model_test_d.csv)

```{r echo = F, eval = T}
DT::datatable(read.csv("data/model_test_d.csv"))
```
...
> - `r shiny::icon("save")` [Supplemental_Table_04.csv](Supplemental_Table_04.csv)
...
```{r echo = F}
DT::datatable(read.csv("Supplemental_Table_04.csv"))
```
...
> - `r shiny::icon("save")` [data/model_3best.csv](data/model_3best.csv)
> - `r shiny::icon("save")` [data/model_3best_d.csv](data/model_3best_d.csv)
> - `r shiny::icon("save")` [data/model_3best_coefs.csv](data/model_3best_coefs.csv)
...
> - `r shiny::icon("save")` [data/model_3worst.csv](data/model_3worst.csv)
> - `r shiny::icon("save")` [data/model_3worst_d.csv](data/model_3worst_d.csv)
> - `r shiny::icon("save")` [data/model_3worst_coefs.csv](data/model_3worst_coefs.csv)
...
# Append (a) and (b)
mp <- ggarrange(mp1, mp2, ncol = 1, common.legend = T, legend = "bottom")
ggsave("Supplemental_Figure_07.png", mp, width = 8, height = 11, dpi = 600, bg = "white")
```
...
> - `r shiny::icon("save")` [data/data_tb_pc.csv](data/data_tb_pc.csv)

```{r echo = F, eval = T}
DT::datatable(read.csv("data/data_tb_pc.csv"))
```
...
ggsave("Supplemental_Figure_09.png", mp, width = 8, height = 10, dpi = 600, bg = "white")
```
...
mp <- ggarrange(mp1, mp2, nrow = 2, ncol = 1, 
                common.legend = T, legend = "bottom")
ggsave("Supplemental_Figure_10.png", mp, width = 8, height = 10, dpi = 600, bg = "white")
```
...
mp <- ggarrange(mp1, mp2, nrow = 2, ncol = 1, 
                common.legend = T, legend = "bottom")
ggsave("Supplemental_Figure_11.png", mp, width = 8, height = 10, dpi = 600, bg = "white")
```
...
> - `r shiny::icon("save")` [data/data_temp_photo_increase.csv](data/data_temp_photo_increase.csv)

```{r echo = F, eval = T}
DT::datatable(read.csv("data/data_temp_photo_increase.csv"))
```
