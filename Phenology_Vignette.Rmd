...
mapBubbles(dF = xx, nameX = "Lon", nameY = "Lat", nameZColour = "MacroEnv",
           ...
           colourPalette = c("darkgreen","darkorange3","darkblue"), addColourLegend = F, addLegend = F,
...
rgl::writeWebGL(filename = "Additional/Additional_Figure_PCA_3D.html", 
...
# Plot
invisible(png("Additional/Additional_Figure_09_LDPOriginsByCluster.png", width = 2400, height = 1100, res = 150))
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
...
ggsave("Additional/Additional_Figure_13_PTT.png", mp, width = 8, height = 10)
```

```{r echo = F}
image_read("Additional/Additional_Figure_13_PTT.png")
```
...
# Additional Figure 14 Temperature Increase By Cluster
...
ggsave("Additional/Additional_Figure_14_TempIncreaseByCluster.png", mp, width = 7, height = 6)
```

```{r echo = F}
image_read("Additional/Additional_Figure_14_TempIncreaseByCluster.png")
```
