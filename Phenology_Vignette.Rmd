...
downloadthis::download_link(
  ...
  button_label = "data/data_ldp.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/data_countries.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/data_raw.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/data_env.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/data_info.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "Additional/pdf_Phenology.pdf",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-file-pdf",
...
for(i in 1:length(names_Expt)) {
  mp <- ggpairs(xx %>% filter(Expt == names_Expt[i]), 
               columns = c("DTE", "DTF", "DTS", "DTM", "VEG", "REP"), 
...
# Plot (a) Temperate
mp1 <- ggpairs(x1, columns = c("DTE", "DTF", "DTS", "DTM", "VEG", "REP"), 
...
# Plot (b) South Asia
mp2 <- ggpairs(x2, columns = c("DTE", "DTF", "DTS", "DTM", "VEG", "REP"), 
               aes(color = Expt, fill = Expt),
        upper  = list(continuous = my_upper),
...
mp3 <- ggpairs(x3, columns = c("DTE", "DTF", "DTS", "DTM", "VEG", "REP"), 
               aes(color = Expt, fill = Expt),
        upper  = list(continuous = my_upper),
...
# Plot All
mp4 <- ggpairs(xx, columns = c("DTE", "DTF", "DTS", "DTM", "VEG", "REP"), 
...
downloadthis::download_link(
  ...
  button_label = "data/data_pca_results.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
```{r echo = F}
downloadthis::download_link(
  link = "Ahttps://github.com/derekmichaelwright/AGILE_LDP_Phenology/blob/master/Additional/Animation_3D.gif",
...
downloadthis::download_link(
  ...
  button_label = "data/model_txp.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/model_txp_d.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/model_txp_coefs.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/model_test.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
downloadthis::download_link(
  ...
  button_label = "data/model_test_d.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
