...
[Phenology_Vignette.pdf][Phenology_Vignette.pdf]
...
[Additional/Additional_Figure_05_PCA_3D.html][Additional/Additional_Figure_05_PCA_3D.html]

```{r echo = F}
htmltools::includeHTML("Additional/Additional_Figure_05_PCA_3D.html")
```
