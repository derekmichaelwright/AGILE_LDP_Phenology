...
> - [View as HTML](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/README.html){target="_blank"}
> - [Source Code Vignette (Phenology_Vignette.html)](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/Phenology_Vignette.html){target="_blank"}
> - [Data](https://github.com/derekmichaelwright/AGILE_LDP_Phenology/tree/master/data){target="_blank"}
...
Download this repository and run `app_AGILE_LDP_Phenology.R` or `app_AGILE_Predict_DTF.R` in `R`

or visit the `shinyapps.oi` links below:

> - [app_AGILE_LDP_Phenology.R](https://derek-wright-usask.shinyapps.io/AGILE_LDP_Phenology/){target="_blank"}
> - [app_AGILE_Predict_DTF.R](https://derek-wright-usask.shinyapps.io/AGILE_Predict_DTF/){target="_blank"}
...
> - [Photothermal Model Results (data/data_model_t+p_coefs.csv)](data/model_t+p_coefs.csv)
...
> - [Nominal Base Temperature and Photoperiod (data/data_tb_pc.csv)](data/data_tb_pc.csv)
...
> - [Response to Temperature or Photoperiod increases (data/data_temp_photo_increase.csv)](data/data_temp_photo_increase.csv)
...
> - [Additional/Additional_Figure_05.html](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/Additional/Additional_Figure_05.html){target="_blank"}
...
> - [Additional/Additional_Figure_06.html](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/Additional/Additional_Figure_06.html){target="_blank"}
...
> - [Additional/Additional_Figure_09.html](https://derekmichaelwright.github.io/AGILE_LDP_Phenology/Additional/Additional_Figure_09.html){target="_blank"}
...
> [Additional/Animation_PCA.gif](Additional/Animation_PCA.gif){target="_blank"}

---

## Phothermal Animation

> - [Additional/Animation_3D.gif](Additional/Animation_3D.gif){target="_blank"}
...
> - [Additional/pdf_Phenology.pdf](Additional/pdf_Phenology.pdf){target="_blank"}

---

## Temperature and Photoperiod Regressions

> - [Additional/pdf_TP.pdf](Additional/pdf_TP.pdf){target="_blank"}

---

## Model Predictions

> - [Additional/pdf_Model.pdf](Additional/pdf_Model.pdf){target="_blank"}

---

## Photothermal Planes 

> - [Additional/pdf_3D.pdf](Additional/pdf_3D.pdf){target="_blank"}
