...
\hypertarget{supplemental-tables-1-2}{%
\section{Supplemental tables 1 \& 2}\label{supplemental-tables-1-2}}
...
\NormalTok{im2 <-}\StringTok{ }\KeywordTok{image_read}\NormalTok{(}\StringTok{"Additional/Temp/Temp_F01_2.png"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{image_scale}\NormalTok{(}\StringTok{"1200x"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\CommentTok{# Prep data}
\NormalTok{x1 <-}\StringTok{ }\NormalTok{ldp }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Origin }\OperatorTok{!=}\StringTok{ "ICARDA"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\section{Figure 2 Data Overview}\label{figure-2-data-overview}}
...
\section{Additional Figures - Entry
...
\StringTok{    }\KeywordTok{annotate_figure}\NormalTok{(}\DataTypeTok{top =}\NormalTok{ figlab)}
  ...
  \KeywordTok{ggsave}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(}\StringTok{"Additional/Entry_Phenology/Phenology_Entry"}\NormalTok{, }\KeywordTok{str_pad}\NormalTok{(i, }\DecValTok{3}\NormalTok{, }\StringTok{"left"}\NormalTok{, }\StringTok{"0"}\NormalTok{), }\StringTok{".png"}\NormalTok{), }
...
\section{Additional Figure 2 DTF DTS
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-13-1}
...
\section{Supplemental Figure 2 Missing
...
\section{Supplemental Figure 3 Correlation
...
\section{Figure 3 PCA}\label{figure-3-pca}}
...
\NormalTok{xx <-}\StringTok{ }\NormalTok{xx }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Origin }\OperatorTok{!=}\StringTok{ "ICARDA"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
\section{Additional Figure 5 Interactive PCA
...
\NormalTok{rgl}\OperatorTok{::}\KeywordTok{writeWebGL}\NormalTok{(}\DataTypeTok{filename =} \StringTok{"Additional/Additional_Figure_PCA_3D.html"}\NormalTok{, }
                \DataTypeTok{width =} \DecValTok{650}\NormalTok{, }\DataTypeTok{height =} \DecValTok{650}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\hypertarget{additional-figure-6-pca}{%
\section{Additional Figure 6 PCA}\label{additional-figure-6-pca}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Prep data}
\NormalTok{xx <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/data_PCA_Results.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Region =} \KeywordTok{ifelse}\NormalTok{(Origin }\OperatorTok{==}\StringTok{ "ICARDA"}\NormalTok{, }\StringTok{"ICARDA"}\NormalTok{, }\KeywordTok{as.character}\NormalTok{(Region)))}
\CommentTok{# Plot}
...
\StringTok{  }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{values =}\NormalTok{ colors[}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{7}\NormalTok{)]) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_shape_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{,}\DecValTok{17}\NormalTok{,}\DecValTok{18}\NormalTok{,}\DecValTok{15}\NormalTok{,}\DecValTok{13}\NormalTok{)) }\OperatorTok{+}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-28-1}

\hypertarget{additional-figure-7-dtf-by-cluster}{%
\section{Additional Figure 7 DTF By
...
\section{Additional Figure 8 Cluster
...
\KeywordTok{mapBubbles}\NormalTok{(}\DataTypeTok{dF =}\NormalTok{ xx, }\DataTypeTok{nameX =} \StringTok{"Lon"}\NormalTok{, }\DataTypeTok{nameY =} \StringTok{"Lat"}\NormalTok{, }\DataTypeTok{nameZColour =} \StringTok{"Cluster"}\NormalTok{,}
           \DataTypeTok{nameZSize =} \StringTok{"Size"}\NormalTok{, }\DataTypeTok{symbolSize =} \FloatTok{0.5}\NormalTok{, }\DataTypeTok{pch =} \DecValTok{20}\NormalTok{, }\DataTypeTok{colourPalette =}\NormalTok{ colors[}\DecValTok{1}\OperatorTok{:}\DecValTok{8}\NormalTok{],}
           \DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{140}\NormalTok{,}\DecValTok{110}\NormalTok{), }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{20}\NormalTok{), }\DataTypeTok{addLegend =}\NormalTok{ F, }\DataTypeTok{addColourLegend =}\NormalTok{ F, }\DataTypeTok{colourLegendTitle =} \OtherTok{NULL}\NormalTok{,}
           \DataTypeTok{oceanCol =} \StringTok{"grey90"}\NormalTok{, }\DataTypeTok{landCol =} \StringTok{"white"}\NormalTok{, }\DataTypeTok{borderCol =} \StringTok{"black"}\NormalTok{)}
\KeywordTok{legend}\NormalTok{(}\OperatorTok{-}\FloatTok{139.5}\NormalTok{, }\FloatTok{15.5}\NormalTok{, }\DataTypeTok{title =} \StringTok{"Cluster"}\NormalTok{, }\DataTypeTok{legend =} \DecValTok{1}\OperatorTok{:}\DecValTok{8}\NormalTok{, }\DataTypeTok{col =}\NormalTok{ colors,}
       \DataTypeTok{pch =} \DecValTok{16}\NormalTok{, }\DataTypeTok{cex =} \DecValTok{2}\NormalTok{, }\DataTypeTok{pt.cex =} \DecValTok{4}\NormalTok{, }\DataTypeTok{box.lwd =} \DecValTok{2}\NormalTok{)}
\KeywordTok{invisible}\NormalTok{(}\KeywordTok{dev.off}\NormalTok{())}
...
\section{PhotoThermal Plane}\label{photothermal-plane}}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-38-1}

\hypertarget{modeling-dtf---functions}{%
\section{Modeling DTF - functions}\label{modeling-dtf---functions}}
...
\NormalTok{  fname <-}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}\StringTok{"Additional/Entry_Model/Model_Entry_"}\NormalTok{, }\KeywordTok{str_pad}\NormalTok{(i, }\DecValTok{3}\NormalTok{, }\DataTypeTok{pad =} \StringTok{"0"}\NormalTok{), }\StringTok{".png"}\NormalTok{)}
  \KeywordTok{ggsave}\NormalTok{(fname, mp[[i]], }\DataTypeTok{width =} \DecValTok{10}\NormalTok{, }\DataTypeTok{height =} \FloatTok{4.25}\NormalTok{)}
\NormalTok{\}}
\KeywordTok{pdf}\NormalTok{(}\StringTok{"Additional/pdf_Model.pdf"}\NormalTok{, }\DataTypeTok{width =} \DecValTok{10}\NormalTok{, }\DataTypeTok{height =} \FloatTok{4.25}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\DecValTok{324}\NormalTok{) \{ }\KeywordTok{print}\NormalTok{(mp[[i]]) \}}
\KeywordTok{dev.off}\NormalTok{() }\CommentTok{#dev.set(dev.next())}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-42-1}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-44-1}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Plot Observed vs Predicted for Temperate Locations}
\NormalTok{mp <-}\StringTok{ }\KeywordTok{gg_model_2}\NormalTok{(xx }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(ExptShort }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Ro16"}\NormalTok{,}\StringTok{"Ro17"}\NormalTok{,}\StringTok{"Su16"}\NormalTok{,}\StringTok{"Su17"}\NormalTok{,}\StringTok{"Su18"}\NormalTok{,}\StringTok{"Us18"}\NormalTok{)))}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-46-1}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-51-1}
...
\NormalTok{x2 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/model_TxP_Coefs.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Model =} \StringTok{"T x P"}\NormalTok{)}
\NormalTok{xx <-}\StringTok{ }\KeywordTok{bind_rows}\NormalTok{(x1, x2) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(Entry) }\OperatorTok{%>%}\StringTok{ }
...
\StringTok{  }\KeywordTok{select}\NormalTok{(Entry, Name, Model, a, b, c, d, RR, Environments, aP, bP, cP, dP)}
...
\KeywordTok{write.csv}\NormalTok{(xx, }\StringTok{"Additional/Additional_Table_01.csv"}\NormalTok{, }\DataTypeTok{na =} \StringTok{""}\NormalTok{, }\DataTypeTok{row.names =}\NormalTok{ F)}
\NormalTok{xx <-}\StringTok{ }\NormalTok{xx }\OperatorTok{%>%}\StringTok{ }\KeywordTok{arrange}\NormalTok{(RR) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Entry =} \KeywordTok{factor}\NormalTok{(Entry, }\DataTypeTok{levels =} \KeywordTok{unique}\NormalTok{(Entry)))}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-56-1}

\hypertarget{additional-figure-11-constants}{%
\section{Additional Figure 11
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-58-1}

\hypertarget{additional-figure-12-coefficient-p-values}{%
\section{Additional Figure 12 Coefficient
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-60-1}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-62-1}

\hypertarget{modeling-dtf-t-p---location-out}{%
\section{Modeling DTF (T + P) - Location
...
\section{Figure 4 Test Model}\label{figure-4-test-model}}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Prep data}
\NormalTok{xx <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/model_Test_d.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Expt =} \KeywordTok{factor}\NormalTok{(Expt, }\DataTypeTok{levels =}\NormalTok{ names_Expt))}
\CommentTok{# Plot Observed vs Predicted}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-67-1}
...
\KeywordTok{sum}\NormalTok{(}\KeywordTok{duplicated}\NormalTok{(}\KeywordTok{paste}\NormalTok{(mt}\OperatorTok{$}\NormalTok{Temperate_Location,mt}\OperatorTok{$}\NormalTok{SouthAsian_Location,mt}\OperatorTok{$}\NormalTok{Mediterranean_Location)))}
...
\NormalTok{      myrow <-}\StringTok{ }\NormalTok{mt}\OperatorTok{$}\NormalTok{Temperate_Location}\OperatorTok{==}\NormalTok{t }\OperatorTok{&}\StringTok{ }\NormalTok{mt}\OperatorTok{$}\NormalTok{SouthAsian_Location}\OperatorTok{==}\NormalTok{s }\OperatorTok{&}\StringTok{ }\NormalTok{mt}\OperatorTok{$}\NormalTok{Mediterranean_Location}\OperatorTok{==}\NormalTok{m}
...
\begin{Highlighting}[]
\CommentTok{# Prep data }
\NormalTok{xx <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/model_3best_d.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Expt =} \KeywordTok{factor}\NormalTok{(Expt, }\DataTypeTok{levels =}\NormalTok{ names_Expt))}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-71-1}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-73-1}
...
\begin{Highlighting}[]
\CommentTok{# Prep data }
\NormalTok{xx <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/model_3Worst_d.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Expt =} \KeywordTok{factor}\NormalTok{(Expt, }\DataTypeTok{levels =}\NormalTok{ names_Expt))}
\KeywordTok{length}\NormalTok{(}\KeywordTok{unique}\NormalTok{(xx}\OperatorTok{$}\NormalTok{Entry))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-78-1}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-82-1}

\hypertarget{supplemental-figure-7-3-best-3-worst}{%
\section{Supplemental Figure 7 3 best 3
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-84-1}

\hypertarget{supplemental-figure-8-compare-constants-all}{%
\section{Supplemental Figure 8 Compare Constants
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-86-1}

\hypertarget{base-temperature-critical-photoperiod}{%
\section{Base Temperature \& Critical
...
\section{Figure 5 Tb and Pc}\label{figure-5-tb-and-pc}}
...
\CommentTok{#x4 <- xx %>% filter(Entry %in% c(76,94,128)) %>%}
...
\CommentTok{#ggsave("Additional/Temp/Temp_F06_2.png", mp2, width = 7, height = 5)}
\CommentTok{# Append ALL}
\NormalTok{mp <-}\StringTok{ }\KeywordTok{ggarrange}\NormalTok{(mp1, mp2, }\DataTypeTok{nrow =} \DecValTok{2}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{, }\DataTypeTok{align =} \StringTok{"hv"}\NormalTok{, }
                \DataTypeTok{labels =} \KeywordTok{c}\NormalTok{(}\StringTok{"A)"}\NormalTok{,}\StringTok{""}\NormalTok{), }\DataTypeTok{font.label =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{face =} \StringTok{"plain"}\NormalTok{)) }\CommentTok{#heights = c(1,1.75),}
\CommentTok{#mp1 <- ggarrange(mp1, mp2, nrow = 2, ncol = 1, heights = c(1,1.75), align = "v")}
\CommentTok{#mp2 <- ggarrange(mp3, mp4, nrow = 1, ncol = 2, common.legend = T, legend = "bottom")}
\CommentTok{#mp <- ggarrange(mp1, mp2, nrow = 2, ncol = 1, heights = c(2,1.25))}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-93-1}

\hypertarget{additional-figure-13-ptt}{%
\section{Additional Figure 13 PTT}\label{additional-figure-13-ptt}}
...
\KeywordTok{ggsave}\NormalTok{(}\StringTok{"Additional/Additional_Figure_13_PTT.png"}\NormalTok{, mp, }\DataTypeTok{width =} \DecValTok{8}\NormalTok{, }\DataTypeTok{height =} \DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-95-1}

\hypertarget{supplemental-figure-10-thermal-sums}{%
\section{Supplemental Figure 10 Thermal
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-97-1}

\hypertarget{supplemental-figure-11-photoperiodic-sums}{%
\section{Supplemental Figure 11 Photoperiodic
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-99-1}

\hypertarget{figure-7-temperature-increase-by-macroenv}{%
\section{Figure 7 Temperature Increase By
...
\midrule
\endhead
Temperate & 0.49 & 4.48\tabularnewline
South Asia & 2.28 & 6.03\tabularnewline
Mediterranean & 2.54 & 18.05\tabularnewline
\bottomrule
\end{longtable}
...
\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-101-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x1 <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/data_Temp_Increase.csv"}\NormalTok{)}
\NormalTok{x2 <-}\StringTok{ }\KeywordTok{select}\NormalTok{(}\KeywordTok{read.csv}\NormalTok{(}\StringTok{"data/data_PCA_Results.csv"}\NormalTok{), Entry, Cluster)}
\NormalTok{xx <-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(x1, x2, }\DataTypeTok{by =} \StringTok{"Entry"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(pca, }\DataTypeTok{by =} \StringTok{"Entry"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Cluster =} \KeywordTok{factor}\NormalTok{(Cluster)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(ExptShort }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Su17"}\NormalTok{, }\StringTok{"It17"}\NormalTok{, }\StringTok{"Ba17"}\NormalTok{)) }
\NormalTok{mp <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(xx, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Cluster, }\DataTypeTok{y =}\NormalTok{ Diff, }\DataTypeTok{fill =}\NormalTok{ Cluster)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_violin}\NormalTok{(}\DataTypeTok{color =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.6}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_quasirandom}\NormalTok{(}\DataTypeTok{color =} \StringTok{"Black"}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.6}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(Expt }\OperatorTok{~}\StringTok{ }\NormalTok{., }\DataTypeTok{scales =} \StringTok{"free"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{theme_AGL }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"none"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{name =} \OtherTok{NULL}\NormalTok{, }\DataTypeTok{values =}\NormalTok{ colors) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \StringTok{"Decrease in days to flower"}\NormalTok{)}
\KeywordTok{ggsave}\NormalTok{(}\StringTok{"Additional/Additional_Figure_14_TempIncreaseByCluster.png"}\NormalTok{, mp, }\DataTypeTok{width =} \DecValTok{7}\NormalTok{, }\DataTypeTok{height =} \DecValTok{6}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=1\linewidth]{Phenology_Vignette_files/figure-latex/unnamed-chunk-103-1}
