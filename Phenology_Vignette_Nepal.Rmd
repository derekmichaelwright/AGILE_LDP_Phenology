...
This vignette contains some of the <i class="fab fa-r-project"></i> code and analysis to go along with the paper: 

`r shiny::icon("newspaper")` [Sandesh Neupane, Rajeev Dhakal, Derek M Wright, Deny K. Shrestha, Bishnu Dhakal and Kirstin E. Bett. (2021) **Strategic Identification of New Genetic Diversity to Expand Lentil (*Lens culinaris* Medik.) Production (Using Nepal as an Example)**. *Agronomy*. 11(10): 1933.](https://www.mdpi.com/2073-4395/11/10/1933/htm)
